  ...
  return(
    <area.Container>
      ...
      <View style={{marginVertical:20, paddingHorizontal:30}}>
        <text.Subtitle2B color={colors.black}>기본 설정</text.Subtitle2B>
        <area.NoHeightArea marBottom={0} paddingH={8} paddingV={8}>
          <SettingItem content="계정 프로필 수정" press={()=>{}}/>
          <SettingItem content="캐릭터별 알림 설정" press={()=>{}}/>
          <SettingItem content="로그아웃" press={()=>{}}/>
        </area.NoHeightArea>
      </View>

      <View style={{marginVertical:20, paddingHorizontal:30}}>
        <text.Subtitle2B color={colors.black}>정보</text.Subtitle2B>
        <area.NoHeightArea marBottom={0} paddingH={8} paddingV={8}>
