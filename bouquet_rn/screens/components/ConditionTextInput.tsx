...
export default function ConditionTextInput({height, placeholder, onChange, keyboard, active} : {height: number,placeholder : string, onChange:any, keyboard:any, active : number}){
  return(
